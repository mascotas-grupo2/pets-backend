...
import { createFollowup, listFollowups, confirmFollowup, getFollowupById, updateFollowup, completeFollowup, deleteFollowup } from "../controllers/followup.controller.js";
